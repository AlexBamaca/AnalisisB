...
- Basado en una investigación y en el documento proporcionado por el asesor, realizar para el caso de estudio, un ejemplo de los siguientes diagramas estructurados:
   ...
   + Diagrama de **de clases y objetos**
...
![Clases](../img/diagrama_clases.drawio.png)
  - Casos de Uso:
![Casos](../img/DiagramaCasosDeUsos.drawio.svg)
  - Secuencia:
![Secuencia](../img/NotificacionDeAlertas.drawio.png)
...
:house: [Ir al inicio de mi GitHub](../readme.md)